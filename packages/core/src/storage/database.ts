...
export class Store {
  ...
  constructor(root: string) {
    ...
    this.db.exec(`
      ...
      CREATE TABLE IF NOT EXISTS candidates(id TEXT PRIMARY KEY,task_id TEXT NOT NULL REFERENCES tasks(id),state TEXT NOT NULL,provenance TEXT NOT NULL,source_hash TEXT NOT NULL,asset_hash TEXT NOT NULL,build_hash TEXT NOT NULL,snapshot TEXT,manifest TEXT NOT NULL,created_at INTEGER NOT NULL);
